...
public enum AvailableBroker {
	 ...
	 */
	DUMP_STATUS_1_2_API("api_1_2_dump_status"), DUMP_STATUS_2_0_API("api_2_0_dump_status"), DUMP_STATUS_2_0_ACTIVITIES_API("api_2_0_activities_dump_status"), SOLR("api_2_0_solr_status");
